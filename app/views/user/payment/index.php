            ...
            <div class="main-content">
                ...
                <div class="trip-summary-container">
                    <div class="trip-summary">
                        <img src="<?= $this->configs->config['pathAssets'] ?>img/room/a(1).jpg" alt="Hotel Room" />
                        <div class="summary-details">
                            <h2>Your trip summary</h2>
                            <div class="summary-item">
                                <span>Check in</span>
                                <span class="bold">Fri, Dec 13</span>
                            </div>
                            <div class="summary-item">
                                <span>Check out</span>
                                <span class="bold">Mon, Dec 16</span>
                            </div>
                            <div class="summary-item">
                                <span>Guests</span>
